...
#import "TLTimeLimitDetailsViewController.h"

#import "MJRefresh.h"

@interface TLTimeLimitViewController (){
...
@implementation TLTimeLimitViewController
...
- (void)viewDidLoad {
    ...
    TLTimeLimitDetailsViewController *homeDetailListViewVC=[[TLTimeLimitDetailsViewController alloc] initWithFrame:CGRectMake(0, 0, self.homeDetailListView.frame.size.width, self.tableView.frame.size.height)];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    TLTimeLimitTableViewCell *cell=[tableView dequeueReusableCellWithIdentifier:tableViewCellIdentifier];
    if (cell==nil) {
        cell=[[TLTimeLimitTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:tableViewCellIdentifier];
    }
