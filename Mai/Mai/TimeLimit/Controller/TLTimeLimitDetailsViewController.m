//
//  TLTimeLimitDetailsViewController.m
//  Mai
//
...
#import "TLTimeLimitDetailsTableViewCell.h"
...
@interface TLTimeLimitDetailsViewController ()<ImagePlayerViewDelegate>{
...
@implementation TLTimeLimitDetailsViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    TLTimeLimitDetailsTableViewCell *cell=[tableView dequeueReusableCellWithIdentifier:tableViewCellIdentifier];
    if (cell==nil) {
        cell=[[TLTimeLimitDetailsTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:tableViewCellIdentifier];
